---
name: intereses-negocios-emprendimiento
description: |
  Skill de consulta y curación temática sobre 'Negocios / emprendimiento'.
  Destilada automáticamente por el pipeline autoreflexivo desde 507
...
trigger_phrases:
  - "qué tengo guardado sobre negocios / emprendimiento"
  - "bookmarks sobre negocios / emprendimiento"
  - "muéstrame mi curación de negocios / emprendimiento"
...
# Negocios / emprendimiento — Skill de consulta de bookmarks
...
2. Si la pregunta requiere búsqueda fina, correr:
   ...
   python "E:/vars/var 5/X-com guardados/consultar_intereses.py" \
          --tema "Negocios / emprendimiento" --query "<keyword>"
   ```
3. Citar tweets concretos con su URL canónica.

## Volumen actual

- **507** bookmarks marcados con este tema.
