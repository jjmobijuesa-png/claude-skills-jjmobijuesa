---
name: intereses-filosofia
description: |
  Skill de consulta y curación temática sobre 'Filosofía y pensamiento'.
  Destilada automáticamente por el pipeline autoreflexivo desde 254
...
trigger_phrases:
  - "qué tengo guardado sobre filosofía y pensamiento"
  - "bookmarks sobre filosofía y pensamiento"
  - "muéstrame mi curación de filosofía y pensamiento"
...
# Filosofía y pensamiento — Skill de consulta de bookmarks
...
2. Si la pregunta requiere búsqueda fina, correr:
   ...
   python "E:/vars/var 5/X-com guardados/consultar_intereses.py" \
          --tema "Filosofía y pensamiento" --query "<keyword>"
   ```
3. Citar tweets concretos con su URL canónica.

## Volumen actual

- **254** bookmarks marcados con este tema.
