---
name: intereses-salud-cuerpo
description: |
  Skill de consulta y curación temática sobre 'Salud / cuerpo / nutrición'.
  Destilada automáticamente por el pipeline autoreflexivo desde 438
...
trigger_phrases:
  - "qué tengo guardado sobre salud / cuerpo / nutrición"
  - "bookmarks sobre salud / cuerpo / nutrición"
  - "muéstrame mi curación de salud / cuerpo / nutrición"
...
# Salud / cuerpo / nutrición — Skill de consulta de bookmarks
...
2. Si la pregunta requiere búsqueda fina, correr:
   ...
   python "E:/vars/var 5/X-com guardados/consultar_intereses.py" \
          --tema "Salud / cuerpo / nutrición" --query "<keyword>"
   ```
3. Citar tweets concretos con su URL canónica.

## Volumen actual

- **438** bookmarks marcados con este tema.
