---
name: intereses-productividad-habitos
description: |
  Skill de consulta y curación temática sobre 'Productividad / hábitos / sistemas'.
  Destilada automáticamente por el pipeline autoreflexivo desde 636
...
trigger_phrases:
  - "qué tengo guardado sobre productividad / hábitos / sistemas"
  - "bookmarks sobre productividad / hábitos / sistemas"
  - "muéstrame mi curación de productividad / hábitos / sistemas"
...
# Productividad / hábitos / sistemas — Skill de consulta de bookmarks
...
2. Si la pregunta requiere búsqueda fina, correr:
   ...
   python "E:/vars/var 5/X-com guardados/consultar_intereses.py" \
          --tema "Productividad / hábitos / sistemas" --query "<keyword>"
   ```
3. Citar tweets concretos con su URL canónica.

## Volumen actual

- **636** bookmarks marcados con este tema.
