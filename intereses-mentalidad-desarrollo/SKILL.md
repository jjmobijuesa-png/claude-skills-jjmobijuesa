---
name: intereses-mentalidad-desarrollo
description: |
  Skill de consulta y curación temática sobre 'Mentalidad / desarrollo personal'.
  Destilada automáticamente por el pipeline autoreflexivo desde 472
...
trigger_phrases:
  - "qué tengo guardado sobre mentalidad / desarrollo personal"
  - "bookmarks sobre mentalidad / desarrollo personal"
  - "muéstrame mi curación de mentalidad / desarrollo personal"
...
# Mentalidad / desarrollo personal — Skill de consulta de bookmarks
...
2. Si la pregunta requiere búsqueda fina, correr:
   ...
   python "E:/vars/var 5/X-com guardados/consultar_intereses.py" \
          --tema "Mentalidad / desarrollo personal" --query "<keyword>"
   ```
3. Citar tweets concretos con su URL canónica.

## Volumen actual

- **472** bookmarks marcados con este tema.
