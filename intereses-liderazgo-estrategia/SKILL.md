---
name: intereses-liderazgo-estrategia
description: |
  Skill de consulta y curación temática sobre 'Liderazgo / poder / estrategia'.
  Destilada automáticamente por el pipeline autoreflexivo desde 610
...
trigger_phrases:
  - "qué tengo guardado sobre liderazgo / poder / estrategia"
  - "bookmarks sobre liderazgo / poder / estrategia"
  - "muéstrame mi curación de liderazgo / poder / estrategia"
...
# Liderazgo / poder / estrategia — Skill de consulta de bookmarks
...
2. Si la pregunta requiere búsqueda fina, correr:
   ...
   python "E:/vars/var 5/X-com guardados/consultar_intereses.py" \
          --tema "Liderazgo / poder / estrategia" --query "<keyword>"
   ```
3. Citar tweets concretos con su URL canónica.

## Volumen actual

- **610** bookmarks marcados con este tema.
