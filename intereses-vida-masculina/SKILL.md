---
name: intereses-vida-masculina
description: |
  Skill de consulta y curación temática sobre 'Vida masculina / valores tradicionales'.
  Destilada automáticamente por el pipeline autoreflexivo desde 688
...
trigger_phrases:
  - "qué tengo guardado sobre vida masculina / valores tradicionales"
  - "bookmarks sobre vida masculina / valores tradicionales"
  - "muéstrame mi curación de vida masculina / valores tradicionales"
...
# Vida masculina / valores tradicionales — Skill de consulta de bookmarks
...
2. Si la pregunta requiere búsqueda fina, correr:
   ...
   python "E:/vars/var 5/X-com guardados/consultar_intereses.py" \
          --tema "Vida masculina / valores tradicionales" --query "<keyword>"
   ```
3. Citar tweets concretos con su URL canónica.

## Volumen actual

- **688** bookmarks marcados con este tema.
