---
name: intereses-tecnologia-programacion
description: |
  Skill de consulta y curación temática sobre 'Tecnología / programación'.
  Destilada automáticamente por el pipeline autoreflexivo desde 85
...
trigger_phrases:
  - "qué tengo guardado sobre tecnología / programación"
  - "bookmarks sobre tecnología / programación"
  - "muéstrame mi curación de tecnología / programación"
idioma_de_salida: español neutro
nivel_madurez: basica
fuente: pipeline autoreflexivo (autoreflex_pipeline.py)
generada: 2026-06-23 23:30
---

# Tecnología / programación — Skill de consulta de bookmarks
...
2. Si la pregunta requiere búsqueda fina, correr:
   ...
   python "E:/vars/var 5/X-com guardados/consultar_intereses.py" \
          --tema "Tecnología / programación" --query "<keyword>"
   ```
3. Citar tweets concretos con su URL canónica.

## Volumen actual

- **85** bookmarks marcados con este tema.
