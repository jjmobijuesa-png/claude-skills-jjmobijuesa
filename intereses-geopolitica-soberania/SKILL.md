---
name: intereses-geopolitica-soberania
description: |
  Skill de consulta y curación temática sobre 'Geopolítica / Estado / soberanía'.
  Destilada automáticamente por el pipeline autoreflexivo desde 979
...
trigger_phrases:
  - "qué tengo guardado sobre geopolítica / estado / soberanía"
  - "bookmarks sobre geopolítica / estado / soberanía"
  - "muéstrame mi curación de geopolítica / estado / soberanía"
...
# Geopolítica / Estado / soberanía — Skill de consulta de bookmarks
...
2. Si la pregunta requiere búsqueda fina, correr:
   ...
   python "E:/vars/var 5/X-com guardados/consultar_intereses.py" \
          --tema "Geopolítica / Estado / soberanía" --query "<keyword>"
   ```
3. Citar tweets concretos con su URL canónica.

## Volumen actual

- **979** bookmarks marcados con este tema.
