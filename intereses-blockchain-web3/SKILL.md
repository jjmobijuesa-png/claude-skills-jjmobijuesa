---
name: intereses-blockchain-web3
description: |
  Skill de consulta y curación temática sobre 'Blockchain / crypto / web3'.
  Destilada automáticamente por el pipeline autoreflexivo desde 223
...
trigger_phrases:
  - "qué tengo guardado sobre blockchain / crypto / web3"
  - "bookmarks sobre blockchain / crypto / web3"
  - "muéstrame mi curación de blockchain / crypto / web3"
...
# Blockchain / crypto / web3 — Skill de consulta de bookmarks
...
2. Si la pregunta requiere búsqueda fina, correr:
   ...
   python "E:/vars/var 5/X-com guardados/consultar_intereses.py" \
          --tema "Blockchain / crypto / web3" --query "<keyword>"
   ```
3. Citar tweets concretos con su URL canónica.

## Volumen actual

- **223** bookmarks marcados con este tema.
