---
name: intereses-historia-arquetipos
description: |
  Skill de consulta y curación temática sobre 'Historia / cultura / arquetipos'.
  Destilada automáticamente por el pipeline autoreflexivo desde 539
...
trigger_phrases:
  - "qué tengo guardado sobre historia / cultura / arquetipos"
  - "bookmarks sobre historia / cultura / arquetipos"
  - "muéstrame mi curación de historia / cultura / arquetipos"
...
# Historia / cultura / arquetipos — Skill de consulta de bookmarks
...
2. Si la pregunta requiere búsqueda fina, correr:
   ...
   python "E:/vars/var 5/X-com guardados/consultar_intereses.py" \
          --tema "Historia / cultura / arquetipos" --query "<keyword>"
   ```
3. Citar tweets concretos con su URL canónica.

## Volumen actual

- **539** bookmarks marcados con este tema.
