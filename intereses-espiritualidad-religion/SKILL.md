---
name: intereses-espiritualidad-religion
description: |
  Skill de consulta y curación temática sobre 'Espiritualidad / religión'.
  Destilada automáticamente por el pipeline autoreflexivo desde 759
...
trigger_phrases:
  - "qué tengo guardado sobre espiritualidad / religión"
  - "bookmarks sobre espiritualidad / religión"
  - "muéstrame mi curación de espiritualidad / religión"
...
# Espiritualidad / religión — Skill de consulta de bookmarks
...
2. Si la pregunta requiere búsqueda fina, correr:
   ...
   python "E:/vars/var 5/X-com guardados/consultar_intereses.py" \
          --tema "Espiritualidad / religión" --query "<keyword>"
   ```
3. Citar tweets concretos con su URL canónica.

## Volumen actual

- **759** bookmarks marcados con este tema.
