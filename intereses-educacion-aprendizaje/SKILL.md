---
name: intereses-educacion-aprendizaje
description: |
  Skill de consulta y curación temática sobre 'Educación / aprendizaje'.
  Destilada automáticamente por el pipeline autoreflexivo desde 917
...
trigger_phrases:
  - "qué tengo guardado sobre educación / aprendizaje"
  - "bookmarks sobre educación / aprendizaje"
  - "muéstrame mi curación de educación / aprendizaje"
...
# Educación / aprendizaje — Skill de consulta de bookmarks
...
2. Si la pregunta requiere búsqueda fina, correr:
   ...
   python "E:/vars/var 5/X-com guardados/consultar_intereses.py" \
          --tema "Educación / aprendizaje" --query "<keyword>"
   ```
3. Citar tweets concretos con su URL canónica.

## Volumen actual

- **917** bookmarks marcados con este tema.
