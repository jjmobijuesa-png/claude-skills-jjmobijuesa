---
name: intereses-ia-llms
description: |
  Skill de consulta y curación temática sobre 'Inteligencia artificial / LLMs'.
  Destilada automáticamente por el pipeline autoreflexivo desde 722
...
trigger_phrases:
  - "qué tengo guardado sobre inteligencia artificial / llms"
  - "bookmarks sobre inteligencia artificial / llms"
  - "muéstrame mi curación de inteligencia artificial / llms"
...
# Inteligencia artificial / LLMs — Skill de consulta de bookmarks
...
2. Si la pregunta requiere búsqueda fina, correr:
   ...
   python "E:/vars/var 5/X-com guardados/consultar_intereses.py" \
          --tema "Inteligencia artificial / LLMs" --query "<keyword>"
   ```
3. Citar tweets concretos con su URL canónica.

## Volumen actual

- **722** bookmarks marcados con este tema.
