---
name: intereses-pensamiento-critico
description: |
  Skill de consulta y curación temática sobre 'Pensamiento crítico / sesgos'.
  Destilada automáticamente por el pipeline autoreflexivo desde 117
...
trigger_phrases:
  - "qué tengo guardado sobre pensamiento crítico / sesgos"
  - "bookmarks sobre pensamiento crítico / sesgos"
  - "muéstrame mi curación de pensamiento crítico / sesgos"
...
# Pensamiento crítico / sesgos — Skill de consulta de bookmarks
...
2. Si la pregunta requiere búsqueda fina, correr:
   ...
   python "E:/vars/var 5/X-com guardados/consultar_intereses.py" \
          --tema "Pensamiento crítico / sesgos" --query "<keyword>"
   ```
3. Citar tweets concretos con su URL canónica.

## Volumen actual

- **117** bookmarks marcados con este tema.
