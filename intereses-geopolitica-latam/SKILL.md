---
name: intereses-geopolitica-latam
description: |
  Skill de consulta y curación temática sobre 'Geopolítica latinoamericana / Ecuador'.
  Destilada automáticamente por el pipeline autoreflexivo desde 156
...
trigger_phrases:
  - "qué tengo guardado sobre geopolítica latinoamericana / ecuador"
  - "bookmarks sobre geopolítica latinoamericana / ecuador"
  - "muéstrame mi curación de geopolítica latinoamericana / ecuador"
...
# Geopolítica latinoamericana / Ecuador — Skill de consulta de bookmarks
...
2. Si la pregunta requiere búsqueda fina, correr:
   ...
   python "E:/vars/var 5/X-com guardados/consultar_intereses.py" \
          --tema "Geopolítica latinoamericana / Ecuador" --query "<keyword>"
   ```
3. Citar tweets concretos con su URL canónica.

## Volumen actual

- **156** bookmarks marcados con este tema.
